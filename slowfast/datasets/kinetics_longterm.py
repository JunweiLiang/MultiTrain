...
class Kinetics_longterm(torch.utils.data.Dataset):
    """
    ...
    def __init__(self, cfg, mode, num_retries=10):
        ...
        # for longterm memory
        # will get mem_clip_num * clip length videos?
        self.memory_clip_num = self.cfg.MVIT.MAX_MEM_LEN
        ...
        with pathmgr.open(path_to_file, "r") as f:
            for clip_idx, path_label in enumerate(f.read().splitlines()):
                ...
                for idx in range(self._num_clips):
                    ...
                    # decide the video clip index here
                    # [0,1,...29, 0...29] for 3x10 test
    ...
    def __getitem__(self, index):
        ...
        if self.mode in ["train", "val"]:
            ...
            # TODO(junwei): check this, why testing need DATA.TRAIN_JITTER_SCALES
        ...
        for i_try in range(self._num_retries):
            ...
            # RGB frames
            # here the frames would be of receptive field of 64 + 128 frames, and 16 * 3 frames in total, under 16x4 and M=2 setting
            frames = decoder.decode(
                ...
                extra_num_clip=self.memory_clip_num,   # sample (extra_num_clip + 1) * sampling_rate * num_frames frames
            )
            ...
            if self.aug:
                ...
                if self.cfg.AUG.NUM_SAMPLE > 1:
                    ...
                    for _ in range(self.cfg.AUG.NUM_SAMPLE):
                        ...
                        new_frames = utils.pack_mem_clips(new_frames, self.memory_clip_num + 1)
            ...
            label = self._labels[index]
            # will simply put frames = [frames]
            #frames = utils.pack_pathway_output(self.cfg, frames)
            # repack the frames into consecutive clips
            # a list of [3, 16, 224, 224]
            frames = utils.pack_mem_clips(frames, self.memory_clip_num + 1)
